...
export const es: typeof en = {
  ...
  about: {
    ...
    members: [
      ...
      { name: "Bryan", role: "Desarrollador Senior", description: "Contribuye con desarrollo senior en aplicaciones escalables, implementación front-end y flujos de integración." },
      { name: "Edwin", role: "Desarrollador Senior", description: "Apoya ejecución senior de ingeniería en productos escalables, integraciones y aplicaciones listas para producción." },

...
export const es: typeof en = {
  ...
  about: {
    ...
    leaders: [
      ...
      { name: "Sergio Pereyra", role: "Project Manager & Delivery Director", description: "Lidera entrega global de software, arquitectura técnica y ejecución de ingeniería en equipos distribuidos y sistemas de clientes." },

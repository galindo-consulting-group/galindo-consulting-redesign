    ...
    <section id="about" className="gcg-shell reveal bg-[#07080c] px-5 py-24 text-slate-100 sm:px-6 lg:px-10">
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-6 flex flex-col gap-3 border-y border-white/10 py-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#00e5ff]">
        ...
        <div className="grid auto-rows-fr grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          {t.about.leaders.map((leader, index) => {
            ...
            return (
              <article key={leader.name} className="gcg-card gcg-topline flex min-h-[500px] flex-col overflow-hidden rounded-[18px]">
        ...
        <div className="mb-6 mt-16 flex items-center justify-between border-y border-white/10 py-4">
          ...
          <p className="font-mono text-sm text-slate-500">04</p>
        </div>
        ...
        <div className="grid auto-rows-fr grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {t.about.members.map((member, index) => {
            ...
            return (
              <article key={member.name} className="gcg-card gcg-topline flex min-h-[480px] flex-col overflow-hidden rounded-[18px]">

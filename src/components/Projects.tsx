            ...
            return (
              <article key={project.title} className="gcg-card gcg-topline flex min-h-[640px] flex-col overflow-hidden rounded-[18px]">
                <div className="relative h-72 overflow-hidden bg-[#0f1117]">
                  ...
                  <span className="absolute bottom-5 left-5 rounded-full border border-white/20 bg-black/40 px-4 py-2 font-mono text-xs font-black uppercase tracking-[0.16em] text-white backdrop-blur">
                    {visual.label}
                  </span>
                </div>

...
export default function IndustryFocus() {
  ...
  return (
    <section className="reveal bg-transparent px-5 py-20 text-[#06315f] sm:px-6 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <span className="gcg-kicker text-xs font-bold uppercase tracking-[0.2em]">{t.industries.eyebrow}</span>
        <h2 className="mt-5 font-serif text-4xl font-normal leading-tight tracking-tight text-[#06315f] sm:text-5xl">{t.industries.title}</h2>

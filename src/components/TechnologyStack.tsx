  ...
  return (
    <section className="reveal bg-transparent px-4 py-16 text-[#06315f] sm:px-6 sm:py-20 lg:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        <h2 className="mt-5 font-serif text-3xl font-normal leading-tight tracking-tight text-[#06315f] sm:text-5xl">{t.technology.title}</h2>
        <div className="gcg-card mt-10 flex flex-wrap justify-center gap-3 rounded-[18px] p-5 sm:p-6">
